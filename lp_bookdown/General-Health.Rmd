...
```{r, fig.width = 8.5, fig.height = 3.8, fig.cap = 'A line graph showing the ten-year time trend for the 3-year aggregate rate of deaths per 100,000 population for 15 to 44 year olds by locality, HSCP, health board and all Scotland'}
...
```{r, fig.width = 7.5, fig.height = 4, fig.cap = "A graph showing the prevalence of physical long term conditions by percentage of population."}
...
ftext(glue("Table {table_num}: Top five physical LTCs in, {LOCALITY} Locality as a percentage of the population for {latest_year_ltc}, compared to {HSCP} HSCP and Scotland."), table_heading_style)
