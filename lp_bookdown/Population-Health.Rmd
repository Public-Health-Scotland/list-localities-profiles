...
-   Figure `r figure_num` shows the LTC estimates for `r LOCALITY` Locality in the financial year `r latest_year_ltc` across all ages. This is based on whether someone has ever had a hospital admission for this condition.

-   Table `r table_num` orders the LTC estimates to show the five most common physical LTCs across all ages at the Locality, Partnership, and Scotland levels.

Below is a breakdown of estimated physical LTCs, for the financial year `r latest_year_ltc`. Figure `r figure_num` shows the estimated percentage of different LTCs in `r LOCALITY` locality, and Table `r table_num` illustrates the five most common physical LTCs across all ages at the locality, partnership, and Scotland levels.
