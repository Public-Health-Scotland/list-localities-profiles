...
```{r}
ftext(
  glue("Table {table_num}: Average life expectancy in years for the latest time periods ({latest_period_life_exp_loc} aggregated years for the locality; {latest_period_life_exp_otherareas} aggregated years for other areas)."),
  table_heading_style
)
