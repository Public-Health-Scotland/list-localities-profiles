...
```{r number-of-dwellings-time-series, fig.width = 8.5, fig.height = 4, warning = FALSE}
houses_ts
...
```{r council-tax-band-plot, fig.width = 7, fig.height = 2, warning = FALSE, fig.cap = 'A bar graph showing the proportion of Households in each council tax band for the locality for the most recent year'}
ctb_plot
