...
```{r load-packages-summary, include=FALSE}
library(knitr)
library(flextable)
library(officer)
library(officedown)
...
```{r hospital-community-care-data}
indicators <- c(
...
```{r set-landscape-orientation, include=FALSE}
