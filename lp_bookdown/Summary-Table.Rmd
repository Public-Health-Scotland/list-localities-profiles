...
usc_values <- tibble(
  ...
  bind_cols(
    bind_rows(
      format_for_summary_table(emergency_adm_outputs$current_all_areas),
      format_for_summary_table(bed_days_outputs$current_all_areas),
      format_for_summary_table(ae_attendances_outputs$current_all_areas),
      format_for_summary_table(delayed_discharges_outputs$current_all_areas),
      format_for_summary_table(ppa_outputs$current_all_areas)
    )
  ) %>%
...
usc_mh_values <- tibble(
  ...
  bind_cols(
    bind_rows(
      format_for_summary_table(bed_days_mh_outputs$current_all_areas),
