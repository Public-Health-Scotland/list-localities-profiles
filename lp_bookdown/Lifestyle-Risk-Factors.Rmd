...
`r ftext(paste0("Figure ",x,": Alcohol-related hospital admission rates by area and over time."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Alcohol-related hospital admissions by area for the latest time period."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Alcohol-specific deaths by area and over time."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Alcohol-specific deaths by area for the latest time period available."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Drug-related hospital admission rates by area and over time."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Drug-related hospital admission rates by area for the latest time period available."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Bowel screening uptake for eligible men and women, by area and over time."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Bowel screening uptake by area for the latest time period available."),table_heading_style)`
