...
`r ftext(paste0("Figure ",x,": Population by age and sex."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Population time trend and projection."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Change in population structure over the last five years."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Map of Data Zones within ",LOCALITY," coloured by SIMD quintiles."),table_heading_style)`
...
`r ftext(paste0("Table ",y,": Percentage of the ", LOCALITY," population living in the 2016 and 2020 SIMD Datazone Quintiles in 2016 and ", pop_max_year," respectively."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Proportion of the population that reside in each 2020 SIMD quintile by domain in ",pop_max_year,"."),table_heading_style)`
...
`r ftext(paste0("Figure ",x,": Percentage of population in 2016 and ",pop_max_year," living in the 2016 and the 2020 SIMD quintiles by domain."),table_heading_style)`
