...
otherloc_names <- data.frame(loc_number = c(1:n_loc), otherloc_names) %>% 
...
col_indicator <- tableGrob("Indicators", theme=ttheme_default(core=list(bg_params = list(fill = "grey50"), 
                                                             fg_params=list(col = "white", fontface=2, fontsize = sizes))))

col_datatype <- tableGrob("Data\nType", theme=ttheme_default(core=list(bg_params = list(fill = "grey50"), 
                                                           fg_params=list(col = "white", fontface=2, fontsize = sizes))))

col_time <- tableGrob("Time\nPeriod", theme=ttheme_default(core=list(bg_params = list(fill = "grey50"), 
                                                           fg_params=list(col = "white", fontface=2, fontsize = sizes))))

#col_loc <- tableGrob(loc_name, theme=ttheme_default(core=list(bg_params = list(fill = "#3F3685"), 
                                                           #  fg_params=list(col = "white", fontface=2, fontsize = sizes))))

col_otherlocs <- tableGrob(otherloc_names, rows = NULL, cols = NULL, 
                       theme=ttheme_default(core=list(bg_params = list(fill = "#9B4393"), 
                                                      fg_params=list(col = "white", fontface=2, fontsize = sizes))))

col_hscp <- tableGrob(hscp_name,theme=ttheme_default(core=list(bg_params = list(fill = "#0078D4"), 
                                                             fg_params=list(col = "white", fontface=2, fontsize = sizes))))

col_scot <- tableGrob("Scotland", theme=ttheme_default(core=list(bg_params = list(fill = "#83BB26"), 
                                                              fg_params=list(col = "white", fontface=2, fontsize = sizes))))


Headings <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)
...
theme_grey <- ttheme_default(core=list(bg_params = list(fill="grey90"),
                                       fg_params = list(fontsize = sizes)),
                             colhead=list(bg_params = list(fill = "white"), 
                                          fg_params=list(fontface=2, fontsize = sizes)))

#theme_loc <- ttheme_default(core=list(bg_params = list(fill = "#C5C3DA"),
                                     #  fg_params = list(fontsize = sizes)),
                            # colhead=list(bg_params = list(fill = "white"), 
                                        #  fg_params=list(fontface=2,fontsize = sizes)))

theme_hscp <- ttheme_default(core=list(bg_params = list(fill = "#B3D7F2"),
                                       fg_params = list(fontsize = sizes)),
                             colhead=list(bg_params = list(fill = "white"), 
                                          fg_params=list(fontface=2, fontsize = sizes)))

theme_scot <- ttheme_default(core=list(bg_params = list(fill = "#DAEBBE"),
                                       fg_params = list(fontsize = sizes)),
                             colhead=list(bg_params = list(fill = "white"), 
                                          fg_params=list(fontface=2,fontsize = sizes)))

theme_otherlocs <- ttheme_default(core=list(bg_params = list(fill = "#E1C7DF"),
                                       fg_params = list(fontsize = sizes)),
                                  colhead=list(bg_params = list(fill = "white"), 
                                               fg_params=list(fontface=2, fontsize = sizes)))
...
Demographics <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)
...
indicators <- c("Total number of households", 
...
Housing <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)


## 2c. General Health ----

indicators <- c("Male average life expectancy in years",
...
time <- c(paste0(latest_period_life_exp_loc, "*"),
...
General_Health <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)
...
indicators <- c("Alcohol-related hospital admissions per 100,000", 
...
time <- c(latest_period_alcohol_hosp, 
...
Lifestyle_Risks <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)


## 2e. Unscheduled Care ----

indicators <- c("Emergency admissions per 100,000", 
...
Unscheduled_Care <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)

## 2f. Unscheduled Care Mental Health ----

indicators <- c("Psychiatric patient hospitalisations per 100,000", 
                "Unscheduled bed days per 100,000")
...
UC_Mental_Health <- gtable_combine(col_indicator, col_datatype, col_time, col_otherlocs, col_hscp, col_scot)
