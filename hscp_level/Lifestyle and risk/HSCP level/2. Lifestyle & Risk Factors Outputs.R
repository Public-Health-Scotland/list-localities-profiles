...
#HSCP <- as.character(filter(lookup, hscp2019name == HSCP))
...
drug_hosp_latest <- unique(filter(drug_hosp, 
                           year == max(drug_hosp$year) & 
                             (area_name == HSCP))$measure)


drug_hosp_earliest <- unique(filter(drug_hosp, 
...
scot_drug_hosp <- filter(drug_hosp, 
                         year == max(drug_hosp$year) & area_name == "Scotland")$measure
...
alcohol_hosp_latest <- unique(filter(alcohol_hosp, 
                              year == max(alcohol_hosp$year) & 
                             (area_name == HSCP))$measure)

alcohol_hosp_earliest <- unique(filter(alcohol_hosp, 
...
scot_alcohol_hosp <- filter(alcohol_hosp, 
                            year == max(alcohol_hosp$year) & area_name == "Scotland")$measure
...
alcohol_deaths_latest <- unique(filter(alcohol_deaths, 
                              year == max(alcohol_deaths$year) & 
                                (area_name == HSCP))$measure)

alcohol_deaths_earliest <- unique(filter(alcohol_deaths, 
...
scot_alcohol_deaths <- filter(alcohol_deaths, 
                            year == max(alcohol_deaths$year) & area_name == "Scotland")$measure
...
bowel_screening_latest <- unique(filter(bowel_screening, 
                           year == max(bowel_screening$year) & 
                             (area_name == HSCP))$measure)

bowel_screening_earliest <- unique(filter(bowel_screening,
...
scot_bowel_screening <- filter(bowel_screening, 
                              year == max(bowel_screening$year) & area_name == "Scotland")$measure
