...
```{r echo = FALSE, fig.width = 8, warning = FALSE, fig.cap = 'A map of the HSCP which is broken down by data zones with the colouring showing the SIMD quintile for each.'}
simd_map
