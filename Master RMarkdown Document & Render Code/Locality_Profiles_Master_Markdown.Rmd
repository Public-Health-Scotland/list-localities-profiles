...
```{r echo = FALSE}
knitr::include_graphics(paste0("/conf/LIST_analytics/West Hub/02 - Scaled Up Work/RMarkdown/Locality Profiles/Master RMarkdown Document & Render Code/Output/maps","/",HSCP,"Services.png"))
...
```{r echo = FALSE, fig.width = 7.6, fig.height = 4, warning = FALSE}
EAs_loc_ts
