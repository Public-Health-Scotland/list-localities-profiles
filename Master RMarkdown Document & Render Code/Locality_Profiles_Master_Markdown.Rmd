...
if (is.na(avg_life_exp_latest_male)) {
  ...
  life_exp_text2 <- glue("In the latest time period available from {latest_period_life_exp_loc} (5-year aggregate), the average life expectancy in {HSCP} HSCP was {avg_life_exp_latest_male} years for men, and {avg_life_exp_latest_fem} years for women. A 10-year time trend can be seen in figure {x}.")
}
```
