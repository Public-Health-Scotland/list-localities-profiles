...
Figure `r x` presents the psychiatric patient hospitalisation 3-year aggregate rate per 100,000 population in the `r HSCP` HSCP from `r loc_psych_hosp$period_short[1]` to `r loc_psych_hosp$period_short[2]`.
