...
<Div custom-style = "Table or chart caption">Figure `r x`: Population by age and sex.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Population time trend and projection.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Change in population structure over the last five years.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Map of Data Zones within `r LOCALITY` coloured by SIMD quintiles.</Div>
...
<Div custom-style = "Table or chart caption">Table `r y`: Percentage of the `r LOCALITY` population living in the 2016 and 2020 SIMD Datazone Quintiles in 2016 and `r pop_max_year` respectively.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Proportion of the population that reside in each 2020 SIMD quintile by domain in `r pop_max_year`.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Percentage of population in 2016 and `r pop_max_year` living in the 2016 and the 2020 SIMD quintiles by domain.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Average life expectancy in men and women over time.</Div>
...
<Div custom-style = "Table or chart caption">Table `r y`: Average life expectancy in years for the latest time periods (`r latest_period_life_exp_loc` aggregated years for the locality; `r latest_period_life_exp_otherareas` aggregated years for other areas).</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Deaths at ages 15 to 44 by area for the latest time period available.</Div>
...
<Div custom-style = "Table or chart caption">Table `r y`: Multi-morbidity of physical long-term conditions by age group in `r latest_year_ltc`.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: The percentage of people with each physical LTC by age group.</Div>
...
<Div custom-style = "Table or chart caption">Table `r y`: Prevalence of the five most common physical LTCs as a percentage of the population across geographical areas (1 is the most prevalent).</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Cancer registration rate over time and by area.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Early deaths from cancer (\<75 years) over time and by area.</Div>
...
<Div custom-style = "Table or chart caption">Table `r y`: Patient hospitalisations by condition and geographical area, age-sex standardised rates per 100,000.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Anxiety, depression and psychosis prescriptions over time and by geographical area.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Percentage population prescribed medication for anxiety, depression and psychosis by area for the latest period available.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Alcohol-related hospital admission rates by area and over time.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Alcohol-related hospital admissions by area for the latest time period.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Alcohol-specific deaths by area and over time.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Alcohol-specific deaths by area for the latest time period available.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Drug-related hospital admission rates by area and over time.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Drug-related hospital admission rates by area for the latest time period available.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Bowel screening uptake for eligible men and women, by area and over time.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Bowel screening uptake by area for the latest time period available.</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Emergency admissions by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Emergency admissions by age group</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Unscheduled acute bed days by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Unscheduled acute bed days by age group</Div>
```{r echo = FALSE, fig.width = 8.5, fig.height = 4, warning = FALSE, fig.cap = "A line graph showing six-year time trends for emergency admissions per 100,000 population split by age group."}
BDs_age_ts
...
<Div custom-style = "Table or chart caption">Figure `r x`: A&E attendances by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: A&E attendances by age group</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Emergency readmissions (28 days) by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Emergency readmissions (28 days) by age group</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Delayed discharge bed days in the population aged 65+ by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Falls in the population aged 65+ by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Psychiatric patient hospitalisations by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Unscheduled mental health specialty bed days by geographical area</Div>
...
<Div custom-style = "Table or chart caption">Figure `r x`: Unscheduled mental health specialty bed days by age group</Div>
...
flextable(dates_extract, theme_fun = NULL) %>%
  set_header_labels(values =c("Section", "Indicator", "Date of data extraction") ) %>% 
  my_ft_format() %>%
  width(width = 6.5/ncol(dates_extract))
```
