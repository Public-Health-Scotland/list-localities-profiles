...
#### Table `r y`: Multi-morbidity estimate of physical long-term conditions by age group in `r latest_year_ltc`. \newline
...
Figure `r x` shows the Long-Term condition prevalence estimates for `r LOCALITY` Locality in the financial year `r latest_year_ltc` for under 65s and over 65s. 
Table `r y` orders the prevalance estimates to show the most common five physical LTCs across all ages at the locality, partnership, and Scotland levels.

#### Figure `r x`: Prevalence estimates for physical LTC by age group for `r LOCALITY` Locality. \newline
...
#### Table `r y`: Prevalence estimates of the five most common physical long-term conditions as a percentage of the population across areas (1 indicates the most prevalent).
