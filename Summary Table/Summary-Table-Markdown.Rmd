...
loc_values <- round_half_up(c(avg_life_exp_latest_male, avg_life_exp_latest_fem, deaths_15_44_latest, ltc_percent_total_latest, NA, NA), 1)
...
# Values
loc_values <- round_half_up(c(alcohol_hosp_latest, NA, NA, bowel_screening_latest), 1)
...
# Values
loc_values <- format(
  c(latest_emergency_adm_loc1, latest_bed_days_loc1, latest_ae_att_loc1, NA, latest_ppa_loc1),
  big.mark = ","
)
