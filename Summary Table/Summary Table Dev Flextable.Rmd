...
other_loc_values <- bind_rows(other_locs_total_pop, other_locs_gender_ratio, other_locs_over65, other_locs_simd)
...
demographic_values <-tibble(indicators, datatype, time, loc_values, other_loc_values,
...
other_loc_values <- bind_rows(other_locs_n_houses, other_locs_perc_discount, other_locs_perc_housesAC, other_locs_perc_housesFH)
...
housing_values <-tibble(indicators, datatype, time, loc_values, other_loc_values,
                          hscp_values, scot_values)
...
other_loc_values <- bind_rows(other_locs_life_exp_male, other_locs_life_exp_fem, other_locs_deaths_15_44, other_locs_ltc, other_locs_cancer, other_locs_adp)
...
general_health_values <-tibble(indicators, datatype, time, loc_values, other_loc_values,
                          hscp_values, scot_values)
...
## Hopsital and Community Care Summary Table
