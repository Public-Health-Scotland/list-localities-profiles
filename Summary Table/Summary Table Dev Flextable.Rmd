...
housing_values <-data.frame(indicators, datatype, time, loc_values, other_loc_values,
                          hscp_values, scot_values)
...
general_health_values <-data.frame(indicators, datatype, time, loc_values, other_loc_values,
                          hscp_values, scot_values)
