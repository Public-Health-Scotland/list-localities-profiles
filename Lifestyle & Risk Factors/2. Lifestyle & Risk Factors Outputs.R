...
drug_hosp_latest <- filter(drug_hosp, 
                           year == max(drug_hosp$year) & 
                             (area_name == LOCALITY & area_type == "Locality"))$measure

drug_hosp_earliest <- filter(drug_hosp, 
...
alcohol_hosp_latest <- filter(alcohol_hosp, 
                              year == max(alcohol_hosp$year) & 
                             (area_name == LOCALITY & area_type == "Locality"))$measure

alcohol_hosp_earliest <- filter(alcohol_hosp, 
...
alcohol_deaths_latest <- filter(alcohol_deaths, 
                              year == max(alcohol_deaths$year) & 
                                (area_name == LOCALITY & area_type == "Locality"))$measure

alcohol_deaths_earliest <- filter(alcohol_deaths, 
...
bowel_screening_latest <- filter(bowel_screening, 
                           year == max(bowel_screening$year) & 
                             (area_name == LOCALITY & area_type == "Locality"))$measure

bowel_screening_earliest <- filter(bowel_screening,
