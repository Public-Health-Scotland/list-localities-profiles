...
slf <- read.fst(paste0("/conf/hscdiip/01-Source-linkage-files/",
...
slf$age_group <- case_when(slf$age < 65 ~ "Under 65",
...
saveRDS(ltc_data, file=paste0(lp_path, "General Health/DATA ", 
