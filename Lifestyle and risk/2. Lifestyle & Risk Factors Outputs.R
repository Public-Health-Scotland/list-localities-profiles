...
drug_hosp_latest <- unique(filter(
  drug_hosp,
...
drug_hosp_earliest <- unique(filter(
  drug_hosp,
...
alcohol_hosp_latest <- unique(filter(
  alcohol_hosp,
  year == max(alcohol_hosp$year) &
    (area_name == HSCP)
)$measure)

alcohol_hosp_earliest <- unique(filter(
  alcohol_hosp,
...
alcohol_deaths_latest <- unique(filter(
  alcohol_deaths,
  year == max(alcohol_deaths$year) &
    (area_name == HSCP)
)$measure)

alcohol_deaths_earliest <- unique(filter(
  alcohol_deaths,
...
bowel_screening_latest <- unique(filter(
  bowel_screening,
  year == max(bowel_screening$year) &
    (area_name == HSCP)
)$measure)

bowel_screening_earliest <- unique(filter(
  bowel_screening,
