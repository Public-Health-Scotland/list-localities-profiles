...
latest_msg_folder <- "2022-12 December"
...
msg_ae_raw <- readRDS(paste0(
  "/conf/LIST_analytics/MSG/", latest_msg_folder,
  "/Breakdowns/3-A&E-Breakdowns.rds"
))
...
# A&E
saveRDS(msg_ae, paste0(exportfolder, "ae_attendances_msg.rds")) # permission denied error LT

# Delayed discharges
saveRDS(msg_dd, paste0(exportfolder, "delayed_discharges_msg.rds")) # permission denied error LT
...
# Falls
saveRDS(smr_falls, paste0(exportfolder, "falls_smr.rds")) # permission denied error LT

# Readmissions
saveRDS(smr_readmissions, paste0(exportfolder, "readmissions_smr.rds")) # permission denied error LT
